...
execute if score $lock_settings bar.config matches 0 run scoreboard players set $mode_old bar.config 0
execute if score $lock_settings bar.config matches 0 run scoreboard players set $load_messages bar.config 1
execute if score $lock_settings bar.config matches 0 if score $slow_update bar.config matches 1 run scoreboard players set $mode_old bar.config 1
