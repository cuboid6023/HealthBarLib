...
execute if entity @e[type=!#bar_lib:exclude_bars,tag=bar.add_bar,tag=!bar.has_bar] as @e[type=!#bar_lib:exclude_bars,tag=bar.add_bar,tag=!bar.has_bar] at @s run function bar_lib:create_healthbar
execute if entity @e[type=!#bar_lib:exclude_bars,tag=bar.has_bar] as @e[type=!#bar_lib:exclude_bars,tag=bar.has_bar] at @s run function bar_lib:health_check
